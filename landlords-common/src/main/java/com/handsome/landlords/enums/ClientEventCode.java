...
public enum ClientEventCode implements Serializable {
	...
	CODE_4P_SHOW_POKERS("4人展示Poker"),

	CODE_ROOM_CREATE_SUCCESS("创建房间成功"),

	CODE_4P_ROOM_CREATE_SUCCESS("四人房间成功"),
	CODE_ROOM_JOIN_SUCCESS("加入房间成功"),

	CODE_4P_ROOM_JOIN_SUCCESS("加入4人房间成功"),
	...
	CODE_4P_GAME_STARTING("开始4人游戏"),

	CODE_GAME_LANDLORD_ELECT("抢地主"),

	CODE_4P_GAME_LANDLORD_ELECT("4人房抢地主"),

	CODE_GAME_LANDLORD_CONFIRM("地主确认"),

	CODE_4P_GAME_LANDLORD_CONFIRM("4人地主确认"),

	CODE_GAME_LANDLORD_CYCLE("地主一轮确认结束"),

	CODE_GAME_POKER_PLAY("出牌回合"),

	CODE_4P_GAME_POKER_PLAY("4人出牌回合"),
	...
	CODE_4P_GAME_POKER_PLAY_MISMATCH("4人出牌不匹配"),

	CODE_GAME_POKER_PLAY_LESS("出牌太小"),

	CODE_4P_GAME_POKER_PLAY_LESS("4人出牌太小"),
	...
	CODE_4P_GAME_POKER_PLAY_CANT_PASS("4人房不允许不出"),

	CODE_GAME_POKER_PLAY_INVALID("无效"),

	CODE_4P_GAME_POKER_PLAY_INVALID("4人房出牌无效"),

	CODE_GAME_POKER_PLAY_ORDER_ERROR("顺序错误"),

	CODE_4P_GAME_POKER_PLAY_ORDER_ERROR("4人房顺序错误"),

	CODE_GAME_OVER("游戏结束"),

	CODE_4P_GAME_OVER("4人游戏结束"),

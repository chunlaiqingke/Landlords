...
public class Room {
	...
	private PokerSell4P lastPokerShell4P;
	...
	public PokerSell4P getLastPokerShell4P() {
		return lastPokerShell4P;
	}

	public void setLastPokerShell4P(PokerSell4P lastPokerShell4P) {
		this.lastPokerShell4P = lastPokerShell4P;
	}
}

...
public class ServerEventListener_CODE_4P_GAME_POKER_PLAY_REDIRECT implements ServerEventListener {
	...
	public void call(ClientSide clientSide, String data) {
		...
		ChannelUtils.pushToClient(clientSide.getChannel(), ClientEventCode.CODE_4P_GAME_POKER_PLAY_REDIRECT, result);
	}
